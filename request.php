...
$record = $renderObj->get_all_lead($_SESSION['userinfo']->id);
...
?>
   ...
   <div class="col-xs-12 toppad" >
        ...
        <form class="form-horizontal" role="form" method = "post" action = "send_request.php">
<!--          <div class="form-group">
            <label class="col-lg-3 control-label">Title :</label>
            <div class="col-lg-8">
              <input class="form-control" value="<?php //echo $name; ?>" name = "work_title" type="text">
            </div>
          </div>-->
...
<!--          <div class="form-group">
		...
		<?php } } ?>
         ...
         <input class="form-control" value="<?php echo $_GET["id"] ?>" name = "work_id" type="hidden">
