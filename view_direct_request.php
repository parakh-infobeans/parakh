...
//echo "<pre>";print_r($get_work_detail);exit;
   ...
   <div class="col-xs-12 toppad" >
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> 
                  ...
                  <?php /* if (array_key_exists($val['status'],$status_flag)) {
                        ...
                        else if($action_stat == "Pending") {
                            echo "Request ".$action_stat;
                        }
                        else {
                            $rating_show = "";
                        } */
              ...
              if($val['rating'] == '1') { echo "+1"; } else { echo "-1"; }  ?></td>
          </tr>
        <?php }
            }
            else {
        ?>
          ...
          <div class="form-group">
            <div class="col-md-9">
              <a href="work_list.php" class="btn btn-default" role="button">Back</a>
              <span></span>
            </div>
          </div>
          </div>
