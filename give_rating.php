   ...
   <div class="col-xs-12 toppad" >
          ...
          <div class="panel panel-info">
		    ...
		    <input class="form-control" type="file">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                    ...
                    <form class="form-horizontal" role="form" method = "post" action = "save_emp_rating.php">
	  ...
	  ?>    
          <div class="form-group">
            ...
            <div class="col-lg-8">
                <label class="col-lg-8 control-label" style="text-align: left; font-weight: normal;"> <?php echo $name; ?> </label> 
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
                <label class="col-lg-8 control-label" style="text-align: left; font-weight: normal;"> <?php echo $title; ?> </label> 
              <!--<input class="form-control" value="" name = "work_title" type="text">-->
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <label class="col-lg-8 control-label" style="text-align: left; font-weight: normal;"> <?php echo $desc; ?> </label>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <label class="col-lg-8 control-label" style="text-align: left; font-weight: normal;"> <?php echo $workdate; ?> </label>
          ...
          <input class="form-control" value="<?php echo $val['from_id'] ?>" name = "team_member" type="hidden">
            <?php } ?>
